...
Status: Shot 3 implementation candidate; hosted release qualification pending.

| Surface | Alpha support |
| --- | --- |
| Scanner target | Native Rust binary |
| Verified development target | Linux x86-64, glibc |
| Rust toolchain used for Shot 3 | 1.96.0 |
...
| Canonical report | JSON schema 2 and Markdown projection |
...
| Static class composition | Literals, repository-local constants, static templates, finite conditionals, standard combinators, configured wrapper names |
...
- CVA variant definitions and static selections;
